...
def create_data_source(
    ...
    """
    Create DLT source for eMoney Account extraction - processes one entity at a time
    ...
    # Use "account" as default for unknown entity types
    if entity_type_normalized not in extractors:
        logger.warning(f"Unknown entity type: {entity_type}, defaulting to 'account'")
        entity_type_normalized = "account"
