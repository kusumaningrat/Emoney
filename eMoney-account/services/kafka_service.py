...
class KafkaStreamService:
    ...
    def __init__(self, extraction_service):
        ...
        # Account Core Entities only topic mapping
        self.topics = {
            # Account Core Entities
            'account': os.environ.get('KAFKA_TOPIC_ACCOUNT', 'emoney_account_account'),
            'accounttype': os.environ.get('KAFKA_TOPIC_ACCOUNTTYPE', 'emoney_account_accounttype'),
            'asset': os.environ.get('KAFKA_TOPIC_ASSET', 'emoney_account_asset'),
            'assetclass': os.environ.get('KAFKA_TOPIC_ASSETCLASS', 'emoney_account_assetclass'),
            'liability': os.environ.get('KAFKA_TOPIC_LIABILITY', 'emoney_account_liability'),
