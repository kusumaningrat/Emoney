...
class Config:
    ...
    APP_TITLE = os.environ.get('APP_TITLE', 'eMoney Account Data Extraction Service')
    APP_DESCRIPTION = os.environ.get('APP_DESCRIPTION', 'Service for extracting and loading eMoney account data using DLT')
    ...
    DB_NAME = os.environ.get('DB_NAME', 'emoney_account_data')
    DB_USER = os.environ.get('DB_USER', 'postgres')
    DB_PASSWORD = os.environ.get('DB_PASSWORD', '')
    DB_SCHEMA = os.environ.get('DB_SCHEMA', 'emoney_account')
    ...
    DLT_PIPELINE_NAME = os.environ.get('DLT_PIPELINE_NAME', 'emoney_account_extraction')
    ...
    # Extraction Control Variables for eMoney Account entities
...
class DevelopmentConfig(Config):
    ...
    DB_NAME = os.environ.get('DB_NAME', 'emoney_account_data_dev')
...
class TestingConfig(Config):
    ...
    # Use test database
    DB_NAME = os.environ.get('DB_NAME', 'emoney_account_data_test')
    DB_SCHEMA = os.environ.get('DB_SCHEMA', 'emoney_account_test')
...
class StagingConfig(Config):
    ...
    DB_NAME = os.environ.get('DB_NAME', 'emoney_account_data_staging')
