"""
Swagger/OpenAPI schema definitions for eMoney Account Extraction API
"""
...
def register_models(api: Api):
    ...
    scan_config_model = api.model('ScanConfig', {
        'scanId': fields.String(
            ...
            example='emoney-account-scan-2025-001'
        ),
        ...
        'type': fields.List(
            fields.String, 
            required=True,
            description='Type of scan (account, accounttype, liability, asset, or assetclass)',
            example=['account']
        ),
