...
document.addEventListener('DOMContentLoaded', function () {
    ...
    header.innerHTML = `
        <div class="header-title">
            ...
            <span class="subtitle">Monitor and manage identity extraction tasks</span>
        </div>
...
function displayTasks(tasks, pagination) {
    ...
    <div class="results-header">
        <h4>Identity Extraction Tasks</h4>
...
function displayTableData(data, currentOffset, limit) {
    if (!data || !data.records || !data.records.length) {
        document.getElementById('results').innerHTML = '<div class="no-data-message"><p>No records available for this entity type.</p></div>';
        return;
    }
...
function createStartScanModal() {
    ...
    modal.innerHTML = `
        <div class="modal-content">
            ...
            <h2>Start New Identity Extraction</h2>
                ...
                <form id="start-scan-form">
                    <div class="form-section">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="scanId" name="scanId" value="emoney-identity-${currentYear}-001" placeholder="e.g., emoney-identity-2025-001" required>
...
function submitScanForm(event) {
    ...
    fetch('/api/scan/start', {
        ...
        .then(data => {
            if (data.success) {
                alert('Identity extraction started successfully!');
                closeStartScanModal();
                fetchTasks();
            } else {
