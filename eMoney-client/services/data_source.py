...
def create_data_source(
    ...
    """
    Create DLT source for eMoney extraction - processes one entity at a time
    ...
    # Use "client" as default for unknown entity types
    if entity_type_normalized not in extractors:
        logger.warning(f"Unknown entity type: {entity_type}, defaulting to 'client'")
        entity_type_normalized = "client"
