"""
Flask-RESTX route definitions for eMoney Data Extraction API with minimal Loki logging
"""
import asyncio
...
def create_api():
    ...
    class GetScanResults(Resource):
        @results_ns.param('tableName', 'Name of the table to query (default: client)', default='client')
        ...
        def get(self, scan_id):
            ...
            try:
                table_name = request.args.get('tableName', 'client')
