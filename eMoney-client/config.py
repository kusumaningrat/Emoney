...
class Config:
    ...
    APP_DESCRIPTION = os.environ.get('APP_DESCRIPTION', 'Service for extracting and loading eMoney data using DLT')
    ...
    DB_NAME = os.environ.get('DB_NAME', 'emoney_data')
    DB_USER = os.environ.get('DB_USER', 'postgres')
    DB_PASSWORD = os.environ.get('DB_PASSWORD', '')
    DB_SCHEMA = os.environ.get('DB_SCHEMA', 'emoney')
    ...
    DLT_PIPELINE_NAME = os.environ.get('DLT_PIPELINE_NAME', 'emoney_extraction')
    ...
    # Extraction Control Variables for eMoney entities
    
    # Client extraction control variables
...
class DevelopmentConfig(Config):
    ...
    DB_NAME = os.environ.get('DB_NAME', 'emoney_data_dev')
...
class TestingConfig(Config):
    ...
    # Use test database
    DB_NAME = os.environ.get('DB_NAME', 'emoney_data_test')
    DB_SCHEMA = os.environ.get('DB_SCHEMA', 'emoney_test')
...
class StagingConfig(Config):
    ...
    DB_NAME = os.environ.get('DB_NAME', 'emoney_data_staging')
