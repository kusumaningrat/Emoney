...
document.addEventListener('DOMContentLoaded', function () {
    ...
    header.innerHTML = `
        <div class="header-title">
            <h1><i class="data-icon"></i>eMoney Identity Extraction Dashboard</h1>
                ...
                <form id="start-scan-form">
                    <div class="form-section">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="scanId" name="scanId" value="emoney-scan-${currentYear}-001" placeholder="e.g., emoney-scan-2025-001" required>
