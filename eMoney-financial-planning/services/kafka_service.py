...
class KafkaStreamService:
    ...
    def __init__(self, extraction_service):
        ...
        # Financial Planning Core Entities only topic mapping
        self.topics = {
            # Financial Planning Core Entities
            'plan': os.environ.get('KAFKA_TOPIC_PLAN', 'emoney_financialplanning_plan'),
            'goal': os.environ.get('KAFKA_TOPIC_GOAL', 'emoney_financialplanning_goal'),
            'scenario': os.environ.get('KAFKA_TOPIC_SCENARIO', 'emoney_financialplanning_scenario'),
            'cashflow': os.environ.get('KAFKA_TOPIC_CASHFLOW', 'emoney_financialplanning_cashflow'),
            'networth': os.environ.get('KAFKA_TOPIC_NETWORTH', 'emoney_financialplanning_networth'),
