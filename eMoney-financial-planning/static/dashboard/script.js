...
document.addEventListener('DOMContentLoaded', function () {
    ...
    header.innerHTML = `
        <div class="header-title">
            <h1><i class="data-icon"></i>eMoney Financial Plan Extraction Dashboard</h1>
            <span class="subtitle">Monitor and manage financial plan extraction tasks</span>
        </div>
...
function displayTasks(tasks, pagination) {
    ...
    <div class="results-header">
        <h4>Financial Plan Extraction Tasks</h4>
...
function createStartScanModal() {
    ...
    modal.innerHTML = `
        <div class="modal-content">
            ...
            <h2>Start New Financial Plan Extraction</h2>
                ...
                <form id="start-scan-form">
                    <div class="form-section">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="scanId" name="scanId" value="emoney-plan-${currentYear}-001" placeholder="e.g., emoney-plan-2025-001" required>
...
function submitScanForm(event) {
    ...
    fetch('/api/scan/start', {
        ...
        .then(data => {
            if (data.success) {
                alert('Financial plan extraction started successfully!');
                closeStartScanModal();
                fetchTasks();
            } else {
