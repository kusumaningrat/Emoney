"""
Swagger/OpenAPI schema definitions for eMoney Service Extraction API
"""
...
def register_models(api: Api):
    ...
    # Filters model for eMoney service entity extraction
    ...
    scan_config_model = api.model('ScanConfig', {
        'scanId': fields.String(
            ...
            example='emoney-service-2025-001'
        ),
        ...
        'type': fields.List(
            fields.String, 
            required=True,
            description='Type of emoney service entity (user, role, permission, office, logon, sharingrule, plan, goal, scenario, cashflow, networth, client, contact, household, relationship, spouse, account, account_type, asset_class, asset, liability)',
            example=['user']
        ),
    ...
    scan_status_model = api.model('ScanStatus', {
        ...
        'type': fields.String(description='emoney service entity type'),
    ...
    entity_properties_model = api.model('EntityProperties', {
        'entityType': fields.String(description='Entity type (user, role, permission, office, logon, sharingrule, plan, goal, scenario, cashflow, networth, client, contact, household, relationship, spouse, account, account_type, asset_class, asset, liability)'),
    ...
    table_info_model = api.model('TableInfo', {
        'name': fields.String(description='Table name (user, role, permission, office, logon, sharingrule, plan, goal, scenario, cashflow, networth, client, contact, household, relationship, spouse, account, account_type, asset_class, asset, liability)'),
