...
class ExtractionService:
    ...
    def __init__(self, config: Dict[str, Any], source_type: str = "emoney_service"):
        self.config = config
    ...
    def create_source_with_checkpoints(
        ...
        try:
            ...
            if latest_checkpoint:
                ...
                entity_type = entity_type.lower() if entity_type else "user"
            ...
            def checkpoint_callback(job_id_param: str, entity_data: Dict[str, Any]):
                ...
                try:
                    ...
                    # entity_data structure: {'entity': 'users', 'records_processed': 100, 'checkpoint_data': {...}}
                    checkpoint_data = {
    ...
    def get_scan_results(
        self, scan_id: str, table_name: str = "user", limit: int = 100, offset: int = 0
    ) -> Dict[str, Any]:
