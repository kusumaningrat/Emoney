"""
Kafka Stream Service - eMoney Service entities only mapping
"""
...
class KafkaStreamService:
    ...
    def __init__(self, extraction_service):
        ...
        # FIXED: eMoney Service-only topic mapping - ADDED sharingrule
        self.topics = {
            # eMoney Service entities
            'user': os.environ.get('KAFKA_TOPIC_USER', 'emoney_service_user'),
            'office': os.environ.get('KAFKA_TOPIC_OFFICE', 'emoney_service_office'),
            'role': os.environ.get('KAFKA_TOPIC_ROLE', 'emoney_service_role'),
            'permission': os.environ.get('KAFKA_TOPIC_PERMISSION', 'emoney_service_permission'),
            'sharingrule': os.environ.get('KAFKA_TOPIC_SHARINGRULE', 'emoney_service_sharingrule'),  
            'logon': os.environ.get('KAFKA_TOPIC_LOGON', 'emoney_service_logon'),
            'plan': os.environ.get('KAFKA_TOPIC_PLAN', 'emoney_service_plan'),
            'goal': os.environ.get('KAFKA_TOPIC_GOAL', 'emoney_service_goal'),
            'scenario': os.environ.get('KAFKA_TOPIC_SCENARIO', 'emoney_service_scenario'),
            'cashflow': os.environ.get('KAFKA_TOPIC_CASHFLOW', 'emoney_service_cashflow'),
            'networth': os.environ.get('KAFKA_TOPIC_NETWORTH', 'emoney_service_networth'),
            'client': os.environ.get('KAFKA_TOPIC_CLIENT', 'emoney_service_client'),
            'contact': os.environ.get('KAFKA_TOPIC_CONTACT', 'emoney_service_contact'),
            'household': os.environ.get('KAFKA_TOPIC_HOUSEHOLD', 'emoney_service_household'),
            'spouse': os.environ.get('KAFKA_TOPIC_SPOUSE', 'emoney_service_spouse'),
            'relationship': os.environ.get('KAFKA_TOPIC_RELATIONSHIP', 'emoney_service_relationship'),
            'account': os.environ.get('KAFKA_TOPIC_ACCOUNT', 'emoney_service_account'),
            'accounttype': os.environ.get('KAFKA_TOPIC_ACCOUNTTYPE', 'emoney_service_accounttype'),
            'asset': os.environ.get('KAFKA_TOPIC_ASSET', 'emoney_service_asset'),
            'assetclass': os.environ.get('KAFKA_TOPIC_ASSETCLASS', 'emoney_service_assetclass'),
            'liability': os.environ.get('KAFKA_TOPIC_LIABILITY', 'emoney_service_liability'),
